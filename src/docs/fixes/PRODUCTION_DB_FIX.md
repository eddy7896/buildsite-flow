...
docker exec Haal-postgres psql -U postgres -d buildflow_db -c "\dt public.agencies"

# Check table structure
docker exec Haal-postgres psql -U postgres -d buildflow_db -c "\d public.agencies"
