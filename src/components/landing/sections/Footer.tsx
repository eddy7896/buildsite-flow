...
const socialLinks = [
  { icon: Twitter, href: 'https://twitter.com/Haal', label: 'Twitter' },
  { icon: Linkedin, href: 'https://linkedin.com/company/Haal', label: 'LinkedIn' },
  { icon: Instagram, href: 'https://instagram.com/Haal', label: 'Instagram' },
];
        ...
        <div className="grid grid-cols-2 md:grid-cols-6 gap-8 lg:gap-12">
          <div className="col-span-2">
            <Link to="/" className="inline-flex items-center gap-2 group">
              ...
              <span className="text-lg font-display font-semibold text-white">Haal</span>
            </Link>
            ...
            <div className="mt-6 space-y-3">
              <div className="flex items-center gap-2 text-sm text-zinc-500">
                ...
                <a href="mailto:hello@Haal.io" className="hover:text-zinc-300 transition-colors">
                  hello@Haal.io
                </a>
              </div>
        ...
        <div className="mt-16 pt-8 border-t border-white/[0.06]">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            <div className="flex items-center gap-4 text-sm text-zinc-600">
              <span>&copy; {currentYear} Haal. All rights reserved.</span>
