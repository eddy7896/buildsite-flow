...
const testimonials = [
  {
    id: 1,
    content: "Haal transformed how we manage our agency. What used to take hours now takes minutes. The all-in-one approach means we finally have visibility across every project and client.",
    author: "Priya Sharma",
    role: "Founder & CEO",
  ...
  {
    id: 3,
    content: "We tried 5 different tools before Haal. Nothing else came close to understanding what an Indian agency actually needs day-to-day.",
    author: "Ananya Reddy",
    ...
    <section ref={ref} className="relative py-16 sm:py-24 lg:py-32 px-4 overflow-hidden">
      ...
      <div className="relative z-10 max-w-6xl mx-auto">
        <SectionTitle
          ...
          description="See what agency founders and teams have to say about transforming their operations with Haal."
        />
