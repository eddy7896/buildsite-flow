...
const faqs = [
  {
    ...
    questions: [
      {
        q: 'How do I get started with Haal?',
      ...
      },
      {
        ...
        a: 'Yes! Haal supports importing data from popular tools like Asana, Trello, Monday.com, and spreadsheets. Our import wizard walks you through the process step by step.',
      },
      {
    ...
    <section id="faq" ref={ref} className="relative py-24 lg:py-32 px-4 overflow-hidden">
      ...
      <div className="relative z-10 max-w-4xl mx-auto">
        <SectionTitle
          ...
          description="Everything you need to know about Haal. Can't find what you're looking for? Reach out to our team."
        />
        ...
        >
          <div className="flex items-center gap-3 text-sm text-zinc-500">
            ...
            <div>
              ...
              <a href="mailto:support@Haal.io" className="text-blue-400 hover:text-blue-300 transition-colors">
                support@Haal.io
              </a>
            </div>
          </div>
