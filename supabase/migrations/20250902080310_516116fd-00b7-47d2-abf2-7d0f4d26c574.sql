-- Remove foreign key constraints and create mock data (final attempt)

-- Drop foreign key constraints temporarily
ALTER TABLE public.profiles DROP CONSTRAINT IF EXISTS profiles_user_id_fkey;
ALTER TABLE public.user_roles DROP CONSTRAINT IF EXISTS user_roles_user_id_fkey;

-- Check if there are any check constraints on employment_type and remove them temporarily
ALTER TABLE public.employee_details DROP CONSTRAINT IF EXISTS employee_details_employment_type_check;
...
-- Create employee details for the employee user (with NULL employment_type to avoid constraint)
